...
func _ready() -> void:
	...
	%MinimumAmount.value_changed.connect(_on_min_payout_value_changed)
...
func update_labels() -> void:
	...
	%MinimumAmount.value = recipient.minimum_payout

func _on_min_payout_value_changed() -> void:
	Global.recipients[recipient_index].minimum_payout = %MinimumAmount.value
